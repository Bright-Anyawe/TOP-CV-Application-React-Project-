...
export default function PracticalExperienceForm({
 ...
 const {
  ...
  const companyName = experienceState.studiesTitle || "";
  const jobPosition = experienceState.studiesMajor || "";
  const jobResponsibilities = experienceState.schoolName || "";
  const jobEntryDate = experienceState.studiesStartDate || "";
  const jobExitDate = experienceState.studiesEndDate || "";
