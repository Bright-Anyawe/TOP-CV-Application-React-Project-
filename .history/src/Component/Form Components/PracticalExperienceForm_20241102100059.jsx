  ...
  useEffect(() => {
   ...
   useEffect(() => {
     if (experienceEditIndex !== null && experienceArray[experienceEditIndex]) {
       ...
       jobPosition = selectedEducation.companyName;
       jobResponsibilities = selectedEducation.companyName;
       jobEntryDate = selectedEducation.companyName;
       jobExitDate = selectedEducation.companyName;
