...
export default function PracticalExperienceForm({
 ...
 const {
  ...
  const companyName =   experienceState, experienceDispatch,
.studiesTitle || "";
  const jobPosition = educationState.studiesMajor || "";
  const jobResponsibilities = educationState.schoolName || "";
  const jobEntryDate = educationState.studiesStartDate || "";
  const jobExitDate = educationState.studiesEndDate || "";
