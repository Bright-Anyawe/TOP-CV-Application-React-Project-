...
export function EducationExperienceForm({
  ...
  const studiesMajor = educationExperience?.studiesTitle || "";.studiesMajor;
  const schoolName = educationExperience.schoolName;
  const studiesStartDate = educationExperience.studiesStartDate;
  const studiesEndDate = educationExperience.studiesEndDate;
