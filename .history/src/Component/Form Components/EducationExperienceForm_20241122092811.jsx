...
export function EducationExperienceForm({
  ...
  const {
    ...
    displayAdditionalBtn, setDisplayAdditionalBtn,
    educationDispatch,
    educationArray,
    setEducationArray,
    editIndex,
  ...
  useEffect(() => {
    ...
    console.log(educationArray[editIndex]);
  ...
  function showEducationDetailsForm() {
    ...
    if (displayEducationDetails === false) {
      ...
      arrowDown.style.transition = "transform 0.3s ease-in-out";
