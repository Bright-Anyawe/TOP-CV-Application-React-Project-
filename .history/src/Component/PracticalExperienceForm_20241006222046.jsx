...
export function PracticalExperienceForm({handleTitleDisplay, schoolName, studiesTitle, studiesDate, userName, email, mobileNumber}) {
  ...
  const [jobResponsibilities,setJobResponsibilitiesError] = useState('')
  const [jobEntryDateContainerobEntryDate,setJobEntryDAteError] = useState('')
  const [jobExitDateError,setJobResponsibilitiesError] = useState('')
