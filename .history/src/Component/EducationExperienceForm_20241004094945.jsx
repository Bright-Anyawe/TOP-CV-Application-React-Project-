...
export function EducationExperienceForm() {
  ...
  const [valueDisplay, setValueDisplay] = useState(false);
   ...
   const practicalVarible =  <PracticalExperienceForm schoolName={schoolName} studiesTitle={studiesTitle} studiesDate={studiesDate} />)practicalVariblepracticalVarible
