...
export function useUserContactForm() {
  ...
  const [isSubmitForUserContact, setIsSubmitForUserContact] = useState(false);
  const [valueDisplayForUserContact, setvalueDisplayForUserContactalueDisplayForUserContact] =
    useState(false);
