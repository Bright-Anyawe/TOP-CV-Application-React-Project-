...
export function UserContactForm({
  ...
  // const userName = state.userContact.name;
  // const userEmail = state.userContact.email;
  // const mobileNumber = state.userContact.number;
  ...
  const isFormComplete =
    state.userName && state.userEmail && state.mobileNumber;
...
const {name, value} = e.target
  ...
  function handleFormValidation(e) {
    ...
    } else if (!state.userName.match(/^[A-Za-z][A-Za-z0-9_ ]{3,29}$/)) {
      return setError(
