...
export function EducationExperienceForm({ sendDataToParent }) {
  ...
  function handleEducationExperience(
    ...
    sendDataToParent((prevState) => ({ ...prevState, schoolName: updateSchoolName, studiesTitle: updateStudiesTitle, studiesDate: updateStudiesDate}))
