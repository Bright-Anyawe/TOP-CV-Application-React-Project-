...
export function EducationExperienceForm({
  ...
  const isFormComplete = educationExperience.StudiesTitle && educationExperience.SchoolName && educationExperience.StudiesMajor && educationExperience.StudiesStartDate && educationExperience.S
