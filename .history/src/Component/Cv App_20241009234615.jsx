  ...
  return (
    ...
    <>  
     ...
     {renderEducationExperience }
      <PracticalExperienceForm handleTitleDisplay={handleTitleDisplay} {props.schoolName, props.studiesTitle, studiesDate, props.userName, props.email, props.mobileNumber} />
    </>
  );
}
