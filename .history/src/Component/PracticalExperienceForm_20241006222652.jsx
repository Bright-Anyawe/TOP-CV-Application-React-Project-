          ...
          <div className="practicalExperienceInputContainer">
            ...
            <div className="PosInJobContainer">
              ...
              <input
                ...
                id="PosInJob"
              />
                            <span className="jobPositionError"> {companyNameError} </span>
            ...
            <div className="JobResponsibilitiesContainer">
              ...
              />
                            <span className="jobResponsibilitiesError"> {companyNameError} </span>
            ...
            <div className="jobEntryDateContainer">
              ...
              <input
                ...
                id="jobEntryDate"
              />
                            <span className="jobEntryDateError"> {companyNameError} </span>
