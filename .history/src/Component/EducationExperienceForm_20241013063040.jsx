...
export function useEducationExperienceForm() {
  ...
  const [displayEducationDetail, setEduValueDisplay] = useState(false);
  ...
  function showEducationDetailForm() {
      ...
      <>
        <section className="educationExperience">
          <form onSubmit={(e) => e.preventDefault()}>
            ...
            <div
              className="educationDetailHeader"
              onClick={showEducationDetailForm}
            >
