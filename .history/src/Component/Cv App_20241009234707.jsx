  ...
  return (
    ...
    <>  
     ...
     {renderEducationExperience }
      <PracticalExperienceForm handleTitleDisplay={handleTitleDisplay} {props.schoolName, props.studiesTitle, propsstudiesDate, props.userName, props.email, props.mobileNumber} />
    </>
  );
}
