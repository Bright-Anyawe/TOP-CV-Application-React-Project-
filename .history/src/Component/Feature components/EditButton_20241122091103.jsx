...
export function Edit({
  ...
  const { educationArray, educationDispatch, setDisplayAdditionalBtn, editIndex, setEditIndex } =
    useContext(EducationContext);

  const { experienceArray, experienceDispatch, setExperienceEditIndex } =
...
console.log(setDisplayAdditionalBtn);
