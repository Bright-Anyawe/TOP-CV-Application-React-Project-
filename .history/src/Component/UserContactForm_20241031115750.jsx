...
export function UserContactForm({
  ...
  const { userContact, dispatch } = useContext(UserContactContext);

  const userName = userContact.userContact.userName;
  const userEmail = userContact.userContact.userEmail;
  const mobileNumber = userContact.userContact.mobileNumber;
