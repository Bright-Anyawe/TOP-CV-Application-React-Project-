...
function CvApp() {
  ...
  function handleTitleDisplay() {
   ...
   function practicalExperienceLocalStorageDataDisplay(setIsSubmit, valueDisplay, hideInputContainer) {
  ...
  return (
    ...
    <>  
      ...
      {contactFormRender}
     {renderEducationExperience }
      <PracticalExperienceForm handleTitleDisplay={handleTitleDisplay} {...{schoolName, studiesTitle, studiesDate, userName, email, mobileNumber}} practicalExperienceLocalStorageDataDisplay={practicalExperienceLocalStorageDataDisplay} />
    </>
  );
}
