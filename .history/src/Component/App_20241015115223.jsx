...
export default function App() {
  ...
  const [displayProfessionalDetails, setDisplayProfessionalDetails] =
    useState(false);
  const [controlSvgDisplay, setControlSvgDisplay] = useState(false);
      ...
      <div id="main-app">
        <section id="cvFormContainer">
          <CvForm
            ...
            setControlSvgDisplay={setControlEmailSvgDisplay}
            hideEdit={hideEdit}
        ...
        <section id="displayMainContainer">
          <DisplayUserContact
            ...
            displayPersonalContact={displayPersonalContact}
            setDisplayPersonalContact={setDisplayPersonalContact}
            controlSvgDisplay={controlSvgDisplay}
            setControlSvgDisplay={setControlSvgDisplay}
            hideEdit={hideEdit}
            setHideEdit={setHideEdit}
          />
